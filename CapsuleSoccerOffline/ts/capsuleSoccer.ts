...
let player1: Player = new Player(80, 270, 150, 270, 25, 10);
player1.maxSpeed = 4;
let player2: Player = new Player(560, 270, 490, 270, 25, 10);
player2.maxSpeed = 4;
player1.score = 0;
player2.score = 0;

let football: Ball = new Ball(320, 270, 15, 6);
...
function gameLogic()
{
    ...
    ctx.fillText(player1.score.toString(), 20, 30);
    ctx.fillText(player2.score.toString(), 600, 30);
}
...
function scoring(player: Player): void
{
    player.score++;
